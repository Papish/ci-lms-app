...
<!--     <li class="dropdown messages-menu">
   ...
   -->
    ...
    <?php 
      // $pro_pic=base_url().'upload/'.$this->session->userdata('profile_pic');
      // if($this->session->userdata('profile_pic')=='')
      // $pro_pic=base_url().'assets/images/avatar/boy.png';
    ?>
    ...
    <li class="dropdown user user-menu">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="user-footer border_gray">
          <div class="pull-left">
            <a href="<?php echo site_url('member/reset_password_form') ?>" class="btn btn-info btn-flat"><?php echo $this->lang->line("change password") ?></a>
          </div>
