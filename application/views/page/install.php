    ...
    <div class="account-wall" id='recovery_form' style='text-align:left; padding:0 15px;'> 
      <form class="form-horizontal" action="<?php echo site_url().'home/installation_action';?>" method="POST">
        ...
        <div class="form-group">
           ...
           <input type="text" value="<?php echo set_value('institute_name'); ?>" name="institute_name" class="form-control col-xs-12"  placeholder="Institute Name ">          
        </div>
        <div class="form-group">
           <label>Institute Address </label>
           <input type="text" value="<?php echo set_value('institute_address'); ?>" name="institute_address" class="form-control col-xs-12"  placeholder="Institute Address ">          
        </div>
        <div class="form-group">
           <label>Institute Phone / Mobile </label>
           <input type="text" value="<?php echo set_value('institute_mobile'); ?>" name="institute_mobile" class="form-control col-xs-12"  placeholder="Institute Phone / Mobile ">          
        </div>   
